...
# ==========================================
TOKEN = "8931357738:AAE80AeuktixHuCX-31VT0SrRPkztKiVKT8"
...
firebase_credentials_json = r"""
{
  ...
  "project_id": "mhpotp-dd393",
  "private_key_id": "a3baaee820763e979669f95a546d527c1b6ae5d4",
  "private_key": "-----BEGIN PRIVATE KEY-----\\n-----END PRIVATE KEY-----\n",
  "client_email": "firebase-adminsdk-fbsvc@mhpotp-dd393.iam.gserviceaccount.com",
  "client_id": "108343889691866388028",
  "auth_uri": "https://accounts.google.com/o/oauth2/auth",
  "token_uri": "https://oauth2.googleapis.com/token",
  "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
  "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-fbsvc%40mhpotp-dd393.iam.gserviceaccount.com",
...
def mask_number(num):
    clean = num.replace("+", "").replace(" ", "")
    if len(clean) > 6: return f"{clean[:3]}mxd{clean[-3:]}"
    elif len(clean) > 2: return f"{clean[:1]}mxd{clean[-1:]}"
    return clean
                    ...
                    for item in parsed_data:
                        ...
                        if unique_id not in processed_otps:
                            ...
                            for fw in bot_settings.get("fw_groups", []):
                                kb = [[{"text": f"{app_full_name}", "icon_custom_emoji_id": "5296369303661067030", "copy_text": {"text": otp}, "style": "success"}]]
                                temp_row = []
...
def system_settings_keyboard():
    return {"inline_keyboard": [
        ...
        [{"text": "mxd Control", "icon_custom_emoji_id": "5193100774988617665", "callback_data": "mxd_control", "style": "primary"},
...
def mxd_control_keyboard():
    ...
    return {"inline_keyboard": [
        [{"text": f"WITHDRAW: {w_status}", "icon_custom_emoji_id": "5348469219761626211", "callback_data": "mxd_toggle_w", "style": "primary"}],
        [{"text": f"MIN WITHDRAW: {bot_settings['min_withdraw']}", "icon_custom_emoji_id": "5352877703043258544", "callback_data": "mxd_min_w", "style": "success"},
         {"text": f"OTP REWARD: {bot_settings['otp_reward']}", "icon_custom_emoji_id": "5190576863226933563", "callback_data": "mxd_otp_r", "style": "primary"}],
        [{"text": f"REFER REWARD: {bot_settings['refer_reward']}", "icon_custom_emoji_id": "5420396762189831222", "callback_data": "mxd_ref_r", "style": "success"},
         {"text": f"COOLDOWN: {bot_settings['cooldown']}s", "icon_custom_emoji_id": "5337172996211648018", "callback_data": "mxd_cool", "style": "primary"}],
        [{"text": f"NUM/REQ: {bot_settings['num_req']}", "icon_custom_emoji_id": "5337132498965010628", "callback_data": "mxd_num_req", "style": "success"},
         {"text": f"NUM/SHARE: {bot_settings['num_share']}", "icon_custom_emoji_id": "5352862640592949843", "callback_data": "mxd_num_share", "style": "primary"}],
        [{"text": f"SUPPORT LINK: {sup_status}", "icon_custom_emoji_id": "5420145051336485498", "callback_data": "mxd_sup_link", "style": "success"},
         {"text": "W. METHODS", "icon_custom_emoji_id": "5190899075968441286", "callback_data": "manage_w_methods", "style": "primary"}],
        [{"text": f"W. GROUP: {grp_status}", "icon_custom_emoji_id": "5420517437885943844", "callback_data": "mxd_w_group", "style": "success"},
         {"text": "BACK", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "system_settings", "style": "danger"}]
    ]}
...
def w_methods_keyboard():
    ...
    kb.append([{"text": "Back", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "mxd_control", "style": "primary"}])
    return {"inline_keyboard": kb}
...
➖➖➖➖➖➖➖➖"""
        ...
        # --- Menu Design Flow ---
            ...
            try:
                ...
                save_db()
                delete_message(chat_id, msg["message_id"])
                edit_message(chat_id, msg_id, render_body_text("🕹 <b>mxd CONTROL PANEL</b>"), reply_markup=mxd_control_keyboard())
            except:
                delete_message(chat_id, msg["message_id"])
                edit_message(chat_id, msg_id, render_body_text("🕹 <b>mxd CONTROL PANEL</b>\n\n❌ Invalid value!"), reply_markup=mxd_control_keyboard())
            del user_states[chat_id]
            del temp_data[chat_id]
            return
...
def handle_callback(call):
    ...
    # --- Menu Design Integration ---
    ...
    elif data == "mxd_control":
        if chat_id in user_states: del user_states[chat_id]
        edit_message(chat_id, msg_id, render_body_text("🕹 <b>mxd CONTROL PANEL</b>"), reply_markup=mxd_control_keyboard())

    elif data == "mxd_toggle_w":
    ...
    elif data.startswith("mxd_"):
        key = data.replace("mxd_", "")
        ...
        if key in key_map:
            ...
            user_states[chat_id] = "set_mxd"
            cancel_kb = {"inline_keyboard": [[{"text": "Cancel", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "cancel_mxd_edit", "style": "danger"}]]}
